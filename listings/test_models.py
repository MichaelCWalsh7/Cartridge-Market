"""
Tests the models for the listings app.
"""
...
class TestListingModel(TestCase):
    ...
    def test_listing_string_method_returns_title(self):
        """
        Tests string method for Listing class
        """
        self.assertEqual(str(self.test_listing), 'testListing')

    def test_listing_instantiation_(self):
        """
        Tests that the parameters to establish a listing are functioning as
        expected.
        """
